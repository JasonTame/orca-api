...
class CandidateController extends Controller
{
    ...
    #[BodyParam('portfolio_url', 'string', "URL to the candidate's portfolio", required: false, example: 'https://portfolio.johnde.com')]
    #[BodyParam('linkedin_url', 'string', "URL to the candidate's LinkedIn profile", required: false, example: 'https://linkedin.com/in/johndoe')]
    #[BodyParam('years_experience', 'integer', 'Years of professional experience', required: false, example: 5)]
    #[BodyParam('current_position', 'string', 'Current job position', required: false, example: 'Senior Developer')]
    #[BodyParam('current_company', 'string', 'Current employer', required: false, example: 'Tech Corp')]
    #[BodyParam('desired_salary', 'number', 'Desired salary', required: false, example: 120000)]
    #[BodyParam('source', 'string', 'Source of the candidate', required: false, enum: CandidateSource::class, example: 'linkedin')]
    #[BodyParam('notes', 'string', 'Additional notes about the candidate', required: false, example: 'Great communication skills')]
    #[BodyParam('status', 'string', 'Status of the candidate', required: false, enum: CandidateStatus::class, example: 'new')]
    ...
    #[BodyParam('source', 'string', 'Source of the candidate', required: false, enum: CandidateSource::class, example: 'linkedin')]
    #[BodyParam('notes', 'string', 'Additional notes about the candidate', required: false, example: 'Great communication skills')]
    #[BodyParam('status', 'string', 'Status of the candidate', required: false, enum: CandidateStatus::class, example: 'interviewing')]
