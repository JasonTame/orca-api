...
class InterviewController extends Controller
{
    ...
    #[BodyParam('application_id', 'integer', 'The ID of the application', required: false, example: 1)]
    #[BodyParam('stage_id', 'integer', 'The ID of the interview stage', required: false, example: 2)]
    #[BodyParam('interviewer_id', 'integer', 'The ID of the interviewer', required: false, example: 3)]
    #[BodyParam('scheduled_at', 'string', 'When the interview is scheduled', required: false, example: '2023-05-20T14:00:00Z')]
    ...
    #[BodyParam('status', 'string', 'Status of the interview', required: false, enum: InterviewStatus::class, example: 'completed')]
    #[BodyParam('technical_score', 'integer', 'Technical assessment score (1-5)', required: false, example: 4)]
